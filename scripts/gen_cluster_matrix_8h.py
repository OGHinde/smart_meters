...
print 'Output path set to '+resources.clustering_matrix_8h
...
for c, code in enumerate(codes):
    ...
    series = code_groups.get_group(code)['VAL_AI'].resample('8H').mean()
    # Weekly ordering
    for idx in range(54):
...
with open(resources.clustering_matrix_8h, 'w') as f:
