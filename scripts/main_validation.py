...
print '\n\nSTART'
print '\nValidating for {} scenario, with {} week behaviour groups and {} user groups.'.format(args.scenario, args.week_K, args.user_K)
n_tr = 0.4
n_val = 0.4
n_tst = n_tr-n_val
...
if args.scenario == 'weekly':
	...
	print '\n\nCLUSTERING:\n'
	cluster_index_list, weights = clustering_box.week_based_clustering(val_clustering_matrix, 
																	   val_code_index, 
