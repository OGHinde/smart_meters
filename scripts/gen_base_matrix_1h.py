...
Resample data into 6 hour periods.
"""
...
print 'Output path set to '+resources.base_matrix_1h
...
for c, code in enumerate(codes):
    ...
    series = code_groups.get_group(code)['VAL_AI'].values
    clustering_matrix[c, :] = series[:periods]

print 'Saving clustering matrix...'
with open(resources.base_matrix_1h, 'w') as f:
